namespace NodeServer.Managers.RaftNameSpace
{
    public class RaftSettings
    {
        ...
        public List<string> ServersAddresses { get; set; } = new List<string> { "http://127.0.0.1:1111", "http://127.0.0.1:2222", "http://127.0.0.1:3333" };/*(Environment.GetEnvironmentVariable("NODES_IPS"))?.Split(":")?.ToList();*/
