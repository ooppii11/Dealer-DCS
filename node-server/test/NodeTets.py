...
def main():
    ...
    try:
        upload_file_request = node_pb2.UploadFileRequest(file_id=FILE_NAME, file_content=FILE_DATA.encode(), type=FILE_TYPE, servers_addresses_where_saved=["localhost", "localhost", "localhost"])
